...
/// Create a snapshot engine configured for GCS storage
///
/// This is a convenience function that creates an engine with GCS storage
/// and the default gzip compression.
///
/// # Arguments
